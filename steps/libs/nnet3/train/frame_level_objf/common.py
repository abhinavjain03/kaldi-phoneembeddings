...
def train_one_iteration(dir, iter, srand, egs_dir,
    ...
    temp='"set-learning-rate name=input learning-rate=0;set-learning-rate name=lda learning-rate=0;set-learning-rate name=ivector learning-rate=0;set-learning-rate name=tdnn1.affine learning-rate=0;set-learning-rate name=tdnn1.relu learning-rate=0;set-learning-rate name=tdnn1.renorm learning-rate=0;set-learning-rate name=tdnn2.affine learning-rate=0;set-learning-rate name=tdnn2.relu learning-rate=0;set-learning-rate name=tdnn2.renorm learning-rate=0;set-learning-rate name=tdnn3.affine learning-rate=0;set-learning-rate name=tdnn3.relu learning-rate=0;set-learning-rate name=tdnn3.renorm learning-rate=0;set-learning-rate name=tdnn4.affine learning-rate=0;set-learning-rate name=tdnn4.relu learning-rate=0;set-learning-rate name=tdnn4.renorm learning-rate=0;set-learning-rate name=tdnn5.affine learning-rate=0;set-learning-rate name=tdnn5.relu learning-rate=0;set-learning-rate name=tdnn5.renorm learning-rate=0;"'


    if get_raw_nnet_from_am:
        raw_model_string = ("nnet3-am-copy --raw=true {0}/{1}.mdl - |".format(dir, iter))
        # raw_model_string = ("nnet3-am-copy --raw=true --learning-rate={0} --scale={1} {2}/{3}.mdl - |".format( learning_rate, shrinkage_value, dir, iter))

    else:
        raw_model_string = ("nnet3-copy {dir}/{iter}.raw - |".format(dir=dir, iter=iter))
        # raw_model_string = ("nnet3-copy --learning-rate={lr} --scale={s} {dir}/{iter}.raw - |".format( lr=learning_rate, s=shrinkage_value, dir=dir, iter=iter))
